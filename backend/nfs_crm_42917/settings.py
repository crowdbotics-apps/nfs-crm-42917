"""
Django settings for nfs_crm_42917 project.
...
ROOT_URLCONF = 'nfs_crm_42917.urls'
...
WSGI_APPLICATION = 'nfs_crm_42917.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "nfs_crm_42917 API",
    "DESCRIPTION": "API documentation for nfs_crm_42917 App",
    "VERSION": "v1",
}
